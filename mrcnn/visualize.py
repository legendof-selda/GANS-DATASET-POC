...
def save_image(image, image_name, boxes, masks, class_ids, scores, class_names, filter_classs_names=None,
    ...
    for label in ids: 
      if label=="building":
        colors.append((219.0,2.0,2.0))
      if label=="tree":
        colors.append((2.0,191.0,71.0))
      if label=="road":
        colors.append((173.0,176.0,4.0))
      if label=="grass":
        colors.append((222.0,127.0,2.0))
      if label=="flag":
        colors.append((138.0,2.0,222.0))
      if label=="car":
        colors.append((2.0,160.0,222.0))
...
def display_instances(image, boxes, masks, class_ids, class_names,
    ...
    plt.savefig("/content/drive/MyDrive/Segmentation/GANS-DATASET-POC/results/image.jpg",bbox_inches='tight',pad_inches=0.0)
    if auto_show:
        plt.show()
